...
function buildEdges(graph: GraphSpec): Edge[] {
...
export const useGraphStore = create<GraphStoreState>((set, get) => ({
  ...
  edges: buildEdges(initial.graph),
  isDirty: false,
  lastSavedAt: null,
  past: [],
  future: [],
  ...
  undo: () => {
    set((state) => {
      ...
      return {
        ...
        edges: buildEdges(previous.graph),
        past,
        future,
        isDirty: true,
      };
