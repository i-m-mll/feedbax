...
export function ScenarioProjectionWorkspace() {
  ...
  useEffect(() => {
    if (previewMode !== 'sampled' || !projectedScenario?.task_spec) {
    ...
    sampleTaskTrials({
      task_spec: projectedScenario.task_spec,
      seed: previewSeed,
      count: previewCount,
    })
      .then((response) => {
  ...
  }, [previewCount, previewMode, previewSeed, projectedScenario?.task_spec]);
