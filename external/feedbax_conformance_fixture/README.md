...
The result schema is `feedbax.external_conformance.result.v10`. Its evidence map
has exactly ten strict-boolean cases. The `unified_plugin_bootstrap` case loads
...
case, and shipped v9 lacks the dynamic-port case, so all reject rather than
