...
The `external_driver_plugin` case constructs a fixture-owned driver through the
same injected application registry without changes to the orchestration CLI.
