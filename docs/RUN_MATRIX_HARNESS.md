...
- Evaluation matrices use `feedbax.spec.evaluation-run-matrix.v1`. It is a new schema
  family and rejects unknown IDs or versions.
- Analysis bundles use `feedbax.spec.analysis-bundle.v3`. The registry mechanically
