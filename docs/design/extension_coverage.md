...
| `E16` | `feedbax/analysis/evaluation_inputs.py:resolve_evaluation_inputs`, `feedbax/analysis/execution_context.py:StagedExecutionContext`, `feedbax/analysis/evaluation_rows.py:project_authenticated_evaluation_rows`, `feedbax/analysis/evaluation_rows.py:require_exact_authored_cartesian_coverage` | `tests/test_evaluation_row_projection.py:test_projects_typed_rows_after_authenticating_authority_and_provenance`, `tests/test_evaluation_row_projection.py:test_exact_authored_cartesian_coverage_reports_structured_delta`, `external/feedbax_conformance_fixture/src/feedbax_external_conformance/cases.py:check_typed_evaluation_row_projection` | Exact manifest, state, producer, and source authorities fail closed before downstream-owned typed state/parameter/metadata/row-key projection. Stable error categories and generic exact authored-Cartesian coverage are public; scientific membership and verdict policy stay downstream. |
