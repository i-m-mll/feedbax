...
The policy deliberately does not guarantee plugin discovery functions,
family-specific loader allowlists, `ComponentRegistry.discover_entry_point_components`,
provider registries, orchestration drivers, run kinds, custody-provider
