...
def _register_default_spec_families(registry: SpecSchemaRegistry) -> None:
    ...
    families = [
        ...
        _family(
            ...
            EXPERIMENT_DOCUMENT_SCHEMA_VERSION,
            owner_module="feedbax.compiler",
            emitted_by=("scientific authoring clients",),
            consumed_by=("feedbax.compiler.resolve_experiment",),
            description="Authored graph, trial, objective, training, observation, and seed binding.",
            required_tests=("tests/test_scientific_compiler_roots.py",),
        ),
        _family(
            "CampaignDocument",
            CAMPAIGN_DOCUMENT_SCHEMA_ID,
            ...
            owner_module="feedbax.compiler",
            emitted_by=("scientific authoring clients",),
            consumed_by=("campaign workflow lowerers",),
            description="Finite experiment variants, products, and bounded branches.",
            required_tests=("tests/test_scientific_compiler_roots.py",),
        ),
        _family(
            "ResolvedExperiment",
            ...
            RESOLVED_EXPERIMENT_SCHEMA_VERSION,
            owner_module="feedbax.compiler",
            emitted_by=("feedbax.compiler.resolve_experiment",),
            consumed_by=("scientific operation lowerers",),
            description="Immutable exact resolved experiment bindings.",
            required_tests=("tests/test_scientific_compiler_roots.py",),
        ),
        _family(
            "DeclarationDocument",
            DECLARATION_DOCUMENT_SCHEMA_ID,
            DECLARATION_DOCUMENT_SCHEMA_VERSION,
            owner_module="feedbax.declarations",
            emitted_by=("feedbax.declarations.serialize_declaration",),
            consumed_by=("feedbax.declarations.load_declaration",),
            description="Canonical durable neutral scientific declaration.",
            required_tests=("tests/test_scientific_declarations.py",),
        ),
        _family(
