...
class ProviderManifest(ProviderModel):
    ...
    health: dict[str, str] = Field(
        default_factory=lambda: {"check": "python:feedbax.integrations.provider.health"}
    )
...
def _schema_models() -> dict[str, type[BaseModel]]:
    return {
        ...
        "EvaluationRunMatrixSpec": analysis_pkg.EvaluationRunMatrixSpec,
...
def provider_manifest() -> ProviderManifest:
    ...
    return ProviderManifest(
        ...
        entry_points={
            "python": "feedbax.integrations.provider:provider_manifest",
