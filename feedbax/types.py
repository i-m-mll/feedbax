"""Type definitions for feedbax.

This module contains type aliases, protocols, and data classes used throughout feedbax.
"""
...
# Re-export from jax_cookbook for convenience
__all__ = [
    # Original feedbax types
    "SeqOf",
    "SeqOfT",
    # From feedbax_experiments
    "LDict",
    "LDictConstructor",
    "LDictTree",
    "TreeNamespace",
...
def _get_analysis_types():
    ...
    return AnalysisInputData, Labels, VarSpec
